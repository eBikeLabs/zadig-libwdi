/*
* ebikelink-ucan-driver-setup.c: Console Driver Installer for a single USB device
 ...
 */
#define DESC        "CANable 9fddea4 github.comnormaldotcomcanable-fw.git"
#define VID         0xAD50
#define PID         0x60C4
#define INF_NAME    "CANable_9fddea4_github.comnormaldotcomcanable-fw.git.inf"
